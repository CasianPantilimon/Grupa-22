...
for casuta in tabla_joc:
    ...
    if casuta_user in tabla_joc:
        ...
        elif tabla_joc[0] == "X" and tabla_joc[6] == "X" and tabla_joc[11] == "X":
            print("HUMAN WINNNNS")
            break
        ...
        # diagonalele pentru X
            ...
            print("HUMAN WINNNNS")
            break
        elif tabla_joc[4] == "X" and tabla_joc[8] == "X" and tabla_joc[11] == "X":
            print("HUMAN WINNNNS")
            break
    ...
    if casuta_PC in tabla_joc:
        ...
        if tabla_joc[0] == "0" and tabla_joc[2] == "0" and tabla_joc[4] == "0":
        ...
        elif tabla_joc[0] == "0" and tabla_joc[6] == "0" and tabla_joc[11] == "0":
            print("PC WINNNNS")
            break
            ...
            print("PC WINNNNS")
            break
        elif tabla_joc[4] == "0" and tabla_joc[8] == "0" and tabla_joc[11] == "0":
            print("PC WINNNNS")
            break
